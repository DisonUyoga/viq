...
const ProductDetails = () => {
  ...
  const {
    ...
    isError,
    error: productError,
  } = useGetProductQuery(item_id);

  if (isLoading) return <Spinner />;
  if (isError) return <p>{JSON.stringify(productError)}</p>;
              ...
              <div className="d-flex flex-column p-3 product__details ">
                ...
                <div className="product__rating d-flex align-items-center gap-5 mb-3">
                  <div className="d-flex flex-column align-items-center justify-content-center">
                    <Stars total_rating={product?.total_rating} />
                    <p>
                      (<span>{product?.total_rating}</span>) ratings
                    </p>
                  </div>
                </div>
                ...
                <div className="d-flex align-items-center gap-5">
                  ...
                  <span>
                    Category: {product?.category?.title.toUpperCase()}
                  </span>
                </div>
        ...
        <Container>
          <Row>
            <Col lg="12">
              ...
              {tab === "desc" ? (
                <div className="tab__content mt-5">{product?.description}</div>
              ) : (
